...
data$Nb_Na_ratio <- data$Nb_COM_est / Na_for_ratios
...
comparison_variables <- c("Year",	"S",	"Nb_LD_est",	"Nb_LD_lower",	"Nb_LD_upper",	"Nb_SA_est",	"Nb_SA_lower",	"Nb_SA_upper", "Nb_COM_est",	"Nb_COM_SD", "Nb_Na_ratio")
