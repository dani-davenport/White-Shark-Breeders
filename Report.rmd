...
Some data which is not strictly 'Raw' is found /Data/Filtration. It is the results of PCA filtration of loci. This can be optionally skipped by setting skip_steps_w_outside_data = "TRUE" in /Scripts/filter_script.R  
...
This markdown file, the associated R scripts (colony_script.R, colony_script2.R, filter_script.R ), the files in  /Data/Raw/ and /Data/Filtration and the executables for COLONY and NeEstimator are all that's required to reproduce this analysis in full.
