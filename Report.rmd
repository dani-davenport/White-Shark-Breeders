...
This markdown file, the associated R scripts (colony_script.R, colony_script2.R, filter_script.R, filter_script_PCA_remove_loci.R), the files in  /Data/Raw/ and the executables for COLONY and NeEstimator are all that's required to reproduce this analysis in full.
