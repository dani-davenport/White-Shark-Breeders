...
COLONY_sims_list <- list(
  ...
  scenario_1 = list(run_length=2, allele_freq = NULL, dropout = 0, error_rate = 0.02, random_seed = 1234), #original
  scenario_2 = list(run_length=2, allele_freq = "overall", dropout = 0, error_rate = 0.02, random_seed = 1234), #original with overall allele ests
  scenario_3 = list(run_length=2, allele_freq = NULL, dropout = 0.011, error_rate = 0.001, random_seed = 1234), #rates from Wang 2018
  scenario_4 = list(run_length=2, allele_freq = "overall", dropout = 0.011, error_rate = 0.001, random_seed = 1234), #rates from Wang 2018 with overall allele ests
  scenario_5 = list(run_length=2, allele_freq = NULL, dropout = 0.004, error_rate = 0.007, random_seed = 1234), #inbetween scenario 1
  scenario_6 = list(run_length=2, allele_freq = "overall", dropout = 0.004, error_rate = 0.007, random_seed = 1234), #inbetween scenario 1 with overall allele ests
  scenario_7 = list(run_length=2, allele_freq = NULL, dropout = 0.007, error_rate = 0.014, random_seed = 1234), #inbetween scenario 2
  scenario_8 = list(run_length=2, allele_freq = "overall", dropout = 0.007, error_rate = 0.014, random_seed = 1234),
  scenario_9 = list(run_length=3, allele_freq = NULL, dropout = 0, error_rate = 0.02, random_seed = 101), #original long run
  scenario_10 = list(run_length=3, allele_freq = NULL, dropout = 0, error_rate = 0.02, random_seed = 100), #original long run
  scenario_11 = list(run_length=2, allele_freq = NULL, dropout = 0, error_rate = 0.02, random_seed = 102) #original med run, same as scenario 1. See if 2 vs 3 makes a difference here
)
