...
for(i in 5:9){
  year <- i + 2005
  colony_filename <- paste(paste0("Data/Processed/COLONY/COLONY_input", year,".txt"))
...
p_crit <- c(0.01, 0.02, 0.05) 
Ne_res <- gl.LDNe(
  new_gl,
  outfile = "NeEstimatorResults.txt",
  outpath = "./Results/NeEstimator",
