...
new_cohort_assignment <- FALSE

#use the new fixed genomes
use_fixed_genotypes <- FALSE
...
#using old data for cohorts and genotypes, no 2014, pcrit 2014, defaults for COLONY will regenerate the original published results exactly
